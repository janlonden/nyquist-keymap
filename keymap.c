...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LEFT_LAYERS] = LAYOUT( \
    ...
    MO(RGB_MODES), KC_TAB, KC_ENT, KC_ESC, _______, _______, _______, _______, _______, _______, _______, _______, \
  ...
  [NUMBERS] = LAYOUT( \
    ...
    _______, LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), _______, _______, _______, _______, KC_4, KC_5, KC_6, _______, \
  ...
  [FUNCTION] = LAYOUT( \
    ...
    _______, KC_LSFT, KC_LALT, KC_TAB, _______, _______, _______, _______, KC_F7, KC_F8, KC_F9, _______, \
    _______, LCTL(KC_PGUP), _______, LCTL(KC_PGDN), _______, _______, _______, _______, KC_F4, KC_F5, KC_F6, _______, \
