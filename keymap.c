...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LEFT_LAYERS] = LAYOUT( \
    ...
    MO(FUNCTION), KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, _______, _______, _______, _______, \
    MO(NUMBERS), MO(DEVELOPMENT), LCTL(KC_BSPACE), KC_BSPACE, _______, _______, _______, _______, _______, _______, _______, _______ \
  ),
  ...
  [FUNCTION] = LAYOUT( \
    ...
    _______, KC_LALT, KC_LSFT, KC_LCTL, _______, _______, _______, _______, KC_F4, KC_F5, KC_F6, _______, \
  ...
  [NUMBERS] = LAYOUT( \
    ...
    _______, KC_LALT, KC_LSFT, KC_LCTL, _______, KC_RALT, _______, _______, KC_0, KC_DOT, _______, KC_ENTER \
  ),
